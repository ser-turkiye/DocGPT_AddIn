...
public class Utils {
    ...
    public static String exportDocumentPart(IDocumentPart partDocument, String exportPath, String prefix) throws IOException {
        String rtrn ="";
        IFDE fde = partDocument.getFDE();
        String fName = (!prefix.isEmpty() ? prefix + "." + ((IFileFDE) fde).getShortFormatDescription() : partDocument.getFilename());
    ...
    public static String exportDocument(IDocument document, String exportPath, String prefix) throws IOException {
        String rtrn ="";
